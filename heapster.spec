...
%global package_name heapster # PACKAGE_NAME
%global product_name TODO # PRODUCT_NAME
%global import_path k8s.io # GO_PACKAGE

Name:           %{package_name}
Version:        %{version}
Release:        %{release}%{?dist}
Summary:        Heapster collects metrics like compute resource usage, lifecycle events, etc.
License:        ASL 2.0
