...
import (
	...
	"heapster/tools/junitreport/pkg/builder/flat"
	"heapster/tools/junitreport/pkg/builder/nested"
	"heapster/tools/junitreport/pkg/parser"
	"heapster/tools/junitreport/pkg/parser/gotest"
	"heapster/tools/junitreport/pkg/parser/oscmd"
)
